		...
		<div class="col-xs-10 col-md-5 col-md-offset-4">
			<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
			    	<div class="input-group">
			     	...
			     	<input type="text" class="form-control" placeholder="Enter your child ID"  aria-describedby="basic-addon1">
			      	</div>
    			</div>

		<div class="col-xs-12 col-md-5 col-md-offset-6">
		<br/><br/><br/><br/>
			<a href="file:///D:/UTM/2015'2016/Short%20SEM/bootstrap-3.3.5-dist/table.html" button type="button" class="btn btn-default">Next</button></a>
		</div>
	</div>
	</div><!--container-->
	</div><!--content-wrapper-->
